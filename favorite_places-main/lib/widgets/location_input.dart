...
class _LocationInputState extends State<LocationInput> {
  ...
  void _selectOnMap() async {
    final pickedLocation =
        await Navigator.of(context).push<LatLng>(MaterialPageRoute(builder: (ctx) => const MapScreen()));
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            TextButton.icon(onPressed: _selectOnMap, icon: const Icon(Icons.map), label: const Text('Select on map'))
          ],
        )
      ],
    );
